    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50 font-sans">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-black text-slate-900 tracking-tight">Notely</h1>
          <p className="text-slate-500 mt-3 font-medium">Notes simplified, beautifully crafted for you.</p>
        </div>
        ...
        <div className="mt-10 pt-10 border-t border-slate-200 flex flex-col gap-4">
           <button 
            onClick={handleGoogleLogin}
            className="flex items-center justify-center gap-3 py-4 bg-white border border-slate-100 rounded-2xl font-black text-sm text-slate-700 hover:bg-slate-50 shadow-sm transition-all active:scale-95"
           >
